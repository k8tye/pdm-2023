...
let spriteSheetFilenames = ["blueBug.png", "redBug.png", "greenBug.png"];
let spriteSheets = [];
let animations = [];
...
function reset() {
  ...
  for(let i=0; i < game.totalSprites; i++) {
    animations[i] = new WalkingAnimation(random(spriteSheets),50,50,random(100,300),random(100,300),3,random(0.5,1),6,random([0,1]));
  }
}
